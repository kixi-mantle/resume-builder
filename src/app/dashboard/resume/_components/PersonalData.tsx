    ...
    <div className="w-full flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex items-center gap-4">
          ...
          {isPending && (
            <div className="w-[80px] h-[80px] border-2 border-accent rounded-lg">
                  <div className="border-4 w-8 h-8 rounded-full border-t-transparent animate-spin bg-red-400"></div>
            </div>
          )
          }
